...
class Command(BaseCommand):
    help = "Send a direct test email to any address to validate SMTP configuration."
    ...
    def handle(self, *args, **options):
        ...
        html_body = (
            "<p>This is a direct SMTP test email from <strong>Service Booking Platform</strong>.</p>"
            "<p>If you received this message, your outbound email configuration is working.</p>"
        )
