...
class ExerciseClass(models.Model):
    ...
    category = models.ForeignKey('Category', null=True, blank=True, on_delete=models.SET_NULL, related_name='exercise_classes')
    instructor = models.ForeignKey('profiles.Instructor', on_delete=models.PROTECT, related_name='classes')
