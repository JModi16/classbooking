...
USE_AWS = os.environ.get("USE_AWS", "").strip().lower() in (
    "1",
    "true",
    "yes",
    "on",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "service_platform.context_processors.nav_search_query",
            ],
            "builtins": [
...
EMAIL_FROM_NAME = os.environ.get(
    "EMAIL_FROM_NAME", "Service Booking Platform"
).strip()
...
# Allauth settings for email confirmation
...
DEFAULT_FROM_EMAIL = os.environ.get(
    "DEFAULT_FROM_EMAIL", formataddr((EMAIL_FROM_NAME, SUPPORT_EMAIL))
)
